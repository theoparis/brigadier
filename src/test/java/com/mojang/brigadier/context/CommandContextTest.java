...
public class CommandContextTest {
	...
	@Mock private CommandDispatcher<Object> dispatcher;

	@Mock private CommandNode<Object> rootNode;
	...
	public void testGetArgument_wrongType() throws Exception {
		final CommandContext<Object> context =
				builder.withArgument("foo", new ParsedArgument<>(0, 1, 123)).build("123");
	...
	public void testGetArgumentOrCompute() throws Exception {
		assertThat(
				builder.build("").getArgumentOrCompute("foo", String.class, () -> "bar"),
				is("bar"));
	}

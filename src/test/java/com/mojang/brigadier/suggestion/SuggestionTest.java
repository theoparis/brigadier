...
public class SuggestionTest {
	...
	public void expand_left() {
		...
		assertThat(
				...
				equalTo(new Suggestion(StringRange.between(0, 1), "foo")));
	}
	...
	public void expand_right() {
		...
		assertThat(
				...
				equalTo(new Suggestion(StringRange.between(0, 4), "minecraft:fish")));
	}
	...
	public void expand_both() {
		...
		assertThat(
				...
				equalTo(new Suggestion(StringRange.between(5, 21), "Steve minecraft:fish_block")));
	}
	...
	public void expand_replacement() {
		...
		assertThat(
				...
				equalTo(new Suggestion(StringRange.between(0, 12), "Hello strangers!")));
	}
}

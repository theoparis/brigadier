...
public class StringReaderTest {
	...
	public void readQuotedString_noOpen() throws Exception {
		try {
			...
			assertThat(
					ex.getType(),
					is(CommandSyntaxException.BUILT_IN_EXCEPTIONS.readerExpectedStartOfQuote()));
	...
	public void readQuotedString_noClose() throws Exception {
		try {
			...
			assertThat(
					ex.getType(),
					is(CommandSyntaxException.BUILT_IN_EXCEPTIONS.readerExpectedEndOfQuote()));
	...
	public void readQuotedString_invalidEscape() throws Exception {
		try {
			...
			assertThat(
					ex.getType(),
					is(CommandSyntaxException.BUILT_IN_EXCEPTIONS.readerInvalidEscape()));
	...
	public void readInt_invalid() throws Exception {
		try {
			...
			assertThat(
					ex.getType(),
					is(CommandSyntaxException.BUILT_IN_EXCEPTIONS.readerInvalidInt()));
			assertThat(ex.getCursor(), is(0));
		}
	}
	...
	public void readLong_invalid() throws Exception {
		try {
			...
			assertThat(
					ex.getType(),
					is(CommandSyntaxException.BUILT_IN_EXCEPTIONS.readerInvalidLong()));
			assertThat(ex.getCursor(), is(0));
		}
	}
	...
	public void readLong_none() throws Exception {
		try {
			...
			assertThat(
					ex.getType(),
					is(CommandSyntaxException.BUILT_IN_EXCEPTIONS.readerExpectedLong()));
			assertThat(ex.getCursor(), is(0));
		}
	}
	...
	public void readDouble_invalid() throws Exception {
		try {
			...
			assertThat(
					ex.getType(),
					is(CommandSyntaxException.BUILT_IN_EXCEPTIONS.readerInvalidDouble()));
			assertThat(ex.getCursor(), is(0));
		}
	}
	...
	public void readDouble_none() throws Exception {
		try {
			...
			assertThat(
					ex.getType(),
					is(CommandSyntaxException.BUILT_IN_EXCEPTIONS.readerExpectedDouble()));
			assertThat(ex.getCursor(), is(0));
		}
	}
	...
	public void readFloat_invalid() throws Exception {
		try {
			...
			assertThat(
					ex.getType(),
					is(CommandSyntaxException.BUILT_IN_EXCEPTIONS.readerInvalidFloat()));
			assertThat(ex.getCursor(), is(0));
		}
	}
	...
	public void readFloat_none() throws Exception {
		try {
			...
			assertThat(
					ex.getType(),
					is(CommandSyntaxException.BUILT_IN_EXCEPTIONS.readerExpectedFloat()));
			assertThat(ex.getCursor(), is(0));
		}
	}
	...
	public void expect_incorrect() throws Exception {
		...
		try {
			...
			assertThat(
					ex.getType(),
					is(CommandSyntaxException.BUILT_IN_EXCEPTIONS.readerExpectedSymbol()));
			assertThat(ex.getCursor(), is(0));
		}
	}
	...
	public void readBoolean_incorrect() throws Exception {
		...
		try {
			...
			assertThat(
					ex.getType(),
					is(CommandSyntaxException.BUILT_IN_EXCEPTIONS.readerInvalidBool()));
			assertThat(ex.getCursor(), is(0));
		}
	}
	...
	public void readBoolean_none() throws Exception {
		...
		try {
			...
			assertThat(
					ex.getType(),
					is(CommandSyntaxException.BUILT_IN_EXCEPTIONS.readerExpectedBool()));
			assertThat(ex.getCursor(), is(0));
		}
	}
}

...
public class SimpleCommandSyntaxExceptionTypeTest {
	...
	public void createWithContext() throws Exception {
		final SimpleCommandExceptionType type =
				new SimpleCommandExceptionType(new LiteralMessage("error"));
	...
	public void getContext_none() throws Exception {
		final CommandSyntaxException exception =
				new CommandSyntaxException(
						mock(CommandExceptionType.class), new LiteralMessage("error"));
	...
	public void getContext_short() throws Exception {
		final CommandSyntaxException exception =
				new CommandSyntaxException(
						mock(CommandExceptionType.class),
